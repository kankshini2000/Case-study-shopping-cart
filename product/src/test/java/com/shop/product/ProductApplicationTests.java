...
class ProductApplicationTests {
	...
	public void testGetProductByd() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/product/admin/getById/" + product.getProductId())
	...
	public void testCreateProduct() throws Exception {
		...
		mockMvc.perform(post("/product/admin/add").contentType(MediaType.APPLICATION_JSON).content(bookJson))
	...
	public void testUpdateProduct() throws Exception {
		...
		when(service.createProduct(product)).thenReturn(product);
		String bookJson = new ObjectMapper().writeValueAsString(product);
		mockMvc.perform(put("/product/admin/update/" + product.getProductId()).contentType(MediaType.APPLICATION_JSON)
	...
	public void testDeleteProduct() throws Exception {
		...
		String bookJson = new ObjectMapper().writeValueAsString(product);
		mockMvc.perform(delete("/product/admin/delete/" + product.getProductId()).contentType(MediaType.APPLICATION_JSON)
